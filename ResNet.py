...
def load_imdb_data(mat_path, img_dir, limit=5000):
    ...
    # Balance the dataset (equal male and female)
...
x = Dropout(0.6)(x)
x = Dense(512, activation='relu', kernel_regularizer=regularizers.l2(0.01))(x)  # Add L2 regularization to fully connected layer
...
model.save("saved_models/resnet152v2_gender.h5")  # Save as H5 file
print("Model saved to saved_models/resnet152v2_gender.h5")
